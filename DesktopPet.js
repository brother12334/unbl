 ...
 *                <script src="https://esheep.petrucci.ch/script/DesktopPet.js"></script>
...
const DEFAULT_XML = "https://esheep.petrucci.ch/script/animation.php"; // default XML animation
...
class eSheep
{
  ...
  _parseXML(text)
  {
    ...
    htmlL.appendChild(document.createTextNode("https://esheep.petrucci.ch"));
    htmlL.setAttribute("href", "https://esheep.petrucci.ch");
